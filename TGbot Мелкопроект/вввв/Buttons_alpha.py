...
Button_time_on_5_min = KeyboardButton('Интервал сообщений 5 минут') # (в разработке)
Button_time_on_10_min = KeyboardButton('Интервал сообщений 10 минут') # (в разработке)
...
# # #(AddToSubscribeCotel(5288656086))
...
Delete_from_Subscribe.row(Button_time_on_5_min, Button_time_on_10_min)
Delete_from_Subscribe.add(FromSubscribe)
...
Add_to_Subscribe = ReplyKeyboardMarkup(resize_keyboard=True).add(BtnMain).row(ToSubscribe, ToFav)
